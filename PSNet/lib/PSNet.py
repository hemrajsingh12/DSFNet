...
class CRC0(nn.Module):    
    def __init__(self,in_dim, out_dim):
        super(CRC0, self).__init__()
...
class PSNet(nn.Module):
    def __init__(self, channel=32,ind=50):
        ...
        self.d1 = BasicConv2d(64, 64, 3, 1,1)
        self.d2 = BasicConv2d(256, 64, 3, 1,1)
        self.d3 = BasicConv2d(512, 64, 3, 1,1)
        self.d4 = BasicConv2d(1024, 64, 3, 1,1)
        self.d5 = BasicConv2d(2048, 64, 3, 1,1)
        # # decoders #       
        self.down = BasicConv2d(1024, 64, 3, 1,1)
        self.down1 = BasicConv2d(128, 64, 3, 1,1)
        self.ful_layer4 = IPF(64)
        #self.ful_layer4 = IPF(128)

        self.upsample = cus_sample
        #............... classification of object.......
        self.classification = BasicConv2d(64, 1, 1, 1)
    ...
    def forward(self, imgs, motions):
        ...
        #------------ CRC.................#
        ful_1    = self.fu_1( gdr_1, self.upsample_8(img_4))
        ful_2    = self.fu_2( self.upsample_1(gdr_2), ful_1)
        ful_3    = self.fu_3( self.upsample_3(gdr_3), ful_2)
        ful_out1 = self.fu_4( self.upsample_8(gdr_4), ful_3)

        #.................. Motion ....................
  
        ful_1    = self.fu_1( gdr_1, self.upsample_8(mot_4))
        ful_2    = self.fu_2( self.upsample_1(gdr_2), ful_1)

        ful_3    = self.fu_3( self.upsample_3(gdr_3), ful_2)
        
        ful_out2 = self.fu_4( self.upsample_8(gdr_4), ful_3)
