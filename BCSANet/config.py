...
ecssd_path = os.path.join(datasets_root, "Saliency/DAVIS", "DAVIS")
dutomron_path = os.path.join(datasets_root, "Saliency/FBMS", "FBMS")
hkuis_path = os.path.join(datasets_root, "Saliency/DAVSOD", "DAVSOD")
pascals_path = os.path.join(datasets_root, "Saliency/SegTrack-V2", "SegTrak-V2")
soc_path = os.path.join(datasets_root, "Saliency/MCL", "MCL")
dutstr_path = os.path.join(datasets_root, "Saliency/DAVSOD-Difficult", "DAVSOD-Difficult")
dutste_path = os.path.join(datasets_root, "Saliency/DAVSOD-Normal", "DAVSOD-Normal")
